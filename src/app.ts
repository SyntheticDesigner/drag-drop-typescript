...
class State<T> {
  ...
  //protected means it can not be accessed from outside the class but can be access from inheriting classes
...
class ProjectState extends State<Project> {
  ...
  addProject(title: string, description: string, numOfPeople: number) {
    ...
    for (const listenerFn of this.listeners) {
      ...
      //using this.projects.slice passes a reference rather than the original array
    }
  }
}
...
//this is an abstract class because it should never be instantiated only ever inherited
