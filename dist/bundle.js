...
define("components/project-list", ["require", "exports", "components/base-component", "models/project-model", "components/project-item", "state/project-state", "decorators/autobind"], function (require, exports, base_component_js_3, project_model_js_2, project_item_js_1, project_state_1, autobind_js_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectList extends base_component_js_3.Component {
        ...
        dropHandler(event) {
            ...
            project_state_1.projectState.moveProject(prjId, this.type === "active" ? project_model_js_2.ProjectStatus.Active : project_model_js_2.ProjectStatus.Finished);
        }
        dragLeaveHandler(_) {
            const listEl = this.element.querySelector("ul");
